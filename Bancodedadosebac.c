...
int registro() //função responsavel por cadastrar os usuário no sistema
{
	...
	printf("Digite o CPF a ser  cadastrador: "); //coletando informação do usário
	scanf("%s",cpf); //%s  refere-se a string
	
	strcpy(arquivo, cpf); //Responsável para copiar os valores da string]
...
int main()
{
	...
	for(laco=1;laco=1;)
	{
	 ...
	 system("cls"); // ele e responsavel para limpar e a tela
	
	 setlocale(LC_ALL, "Portuguese"); //definindo a linguagem
	
	 printf("Banco de Dados WSDA/EBAC\n\n"); //inicio do menu
